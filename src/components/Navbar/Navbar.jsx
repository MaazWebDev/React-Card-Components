function Navbar() {
    return (
      <div
        className="navbar bg-white px-6 py-4 shadow-md sticky top-0 z-50"
        style={{
      ...
      >
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              <li>
                <a className="hover:bg-gray-100">Home</a>
              </li>
              <li>
                <a className="hover:bg-gray-100">Portfolio</a>
              </li>
              <li>
                <a className="hover:bg-gray-100">About</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="navbar-center">
          <a
            href="#"
            className="text-xl font-bold text-gray-900 hover:text-blue-500 transition-all"
          >
            IT LAB
          </a>
        </div>
